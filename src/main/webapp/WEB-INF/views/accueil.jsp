		...
		<div class="container">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					<li class="active"><a href="accueil"><span
							class="glyphicon glyphicon-home"></span> Publier Service</a></li>
					<li class=""><a href="accueilUpdate"> Modifier Service</a></li>
				</ul>
			</div>
			<!--/.nav-collapse -->
		</div>
	...
	<div class="container">
		<div class="jumbotron"  style="
			...
			<div class="page-header" >
				<h3>
					Registry de la mairie de mizemply sous séchoir
				</h3>
			</div>
		</div>
	</div>
			...
			<form:form class="form form-horizontal" method="POST"
				...
				<fieldset>
					...
					<fieldset>
						...
						<div class="form-group">
							<label class="col-sm-3 control-label" for="nameService">Nom du service :*</label>
							<div class="col-sm-6">
								<input id="nameService" class="form-control" 
									type="text" name="nameService" required="required" />
							</div>
						</div>
						
						<div class="form-group">
							<label class="col-sm-3 control-label" for="url">Url du service :*</label>
							<div class="col-sm-6">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label" for="description">Description
								du service :* </label>
							<div class="col-sm-6">
								<textarea class="form-control" placeholder="Décrivez votre service."
